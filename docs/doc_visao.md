...
| Algum membro da equipe trancar a disciplina |         As atividades da pessoa em questão teram que ser repassadas, dificultando o andamento do projeto e sobrecarga nos membros restantes          |     Baixa     |             Replanejamento das atividades e reatribuição para os membros restantes.             |
